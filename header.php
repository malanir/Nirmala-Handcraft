	...
	<div class="container-fluid">
		<div class="row top">
			<center>
				...
				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> nirmala16@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Nirmala Handcraft Indonesia</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #ff8680"><b>Nirmala Handcraft</b></a>
			</div>
